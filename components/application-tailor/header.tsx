...
import { WandSparkles, Crown, LogIn, LogOut, Menu } from "lucide-react";
import {
    DropdownMenu,
    DropdownMenuContent,
    DropdownMenuItem,
...
export const ApplicationTailorHeader = () => {
                            ...
                            <>
                                <DropdownMenu open={open} onOpenChange={setOpen} >
                                    <DropdownMenuTrigger>
                                        <div className="sm:flex items-center gap-3 px-4 py-2 rounded-lg bg-purple-600 backdrop-blur-md border border-white/20">
                                            ...
                                            <div className="hidden md:block">
                                                ...
                                                {user?.isProJobApplicationTailor && hasActiveSubscription && !isLoading && (
                                    ...
                                    <DropdownMenuContent>
                                        ...
                                        {!user?.isProJobApplicationTailor && !isLoading && (
                                            <DropdownMenuItem>
                                                <h1
